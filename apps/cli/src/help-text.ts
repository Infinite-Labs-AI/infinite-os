...
export function localHelpText(): string {
  return [
    ...
    "  meta <campaign|adset> budget <id> --source-id <id> (--daily-budget <cents> | --lifetime-budget <cents>)   (change an existing budget of the same type; no status change)",
    "  meta ad update <id> --source-id <id> [--name <s>] [--creative-id <id>]   (rename an ad and/or swap its creative; no status change)",
