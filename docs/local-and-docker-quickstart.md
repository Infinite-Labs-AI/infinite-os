...
Once the stack is up, drive it with the `infinite` CLI — `./infinite local setup`, then
`./infinite local`. See the [README](../README.md#commands) for the full command list.
