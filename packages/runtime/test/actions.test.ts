...
describe("Infinite OS runtime action registry", () => {
  it("registers first-phase and curated read actions and providers", () => {
    ...
    expect(FIRST_PHASE_QUERYABLE_VIEWS).toContain("queryable.vw_stripe_subscription_lifecycle");
    expect(FIRST_PHASE_QUERYABLE_VIEWS).toContain("queryable.vw_stripe_paid_subscribers");
    expect(FIRST_PHASE_METRICS).toContain("stripe_current_paid_subscribers");
    expect(FIRST_PHASE_METRICS).toContain("stripe_new_paid_subscribers");
    expect(FIRST_PHASE_METRICS).toContain("stripe_trialing_subscribers");
    expect(FIRST_PHASE_METRICS).toContain("stripe_churned_subscribers");
    expect(FIRST_PHASE_METRICS).toContain("stripe_paid_subscribers");
