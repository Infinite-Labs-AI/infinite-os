        ...
        ? [
            {
              ...
              snippet:
                framework === "static-html"
                  ? wrapHtmlSnippet(buildPostHogBootstrapSnippet(projectKey!, apiHostOrigin!))
                  : buildPostHogBootstrapSnippet(projectKey!, apiHostOrigin!)
            }
          ]
        : []
    }
...
export function buildPostHogBootstrapSnippet(projectKey: string, apiHost: string): string {
  return [
