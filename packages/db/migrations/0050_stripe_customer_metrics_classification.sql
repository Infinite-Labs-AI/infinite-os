-- Exclude explicitly classified internal/test Stripe customers from every
-- subscription lifecycle metric without changing their billing state.

alter table stripe_customers
  add column if not exists metrics_classification text;
...
set caveats = 'connected_stripe_source;current_paid_is_snapshot;new_paid_uses_trial_end_or_subscription_created_at;trialing_is_separate_from_paid;mrr_from_subscription_items;customer_metrics_classification_exclusion'
