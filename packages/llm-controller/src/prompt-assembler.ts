...
export function assembleInfiniteOsPrompt(input: PromptAssemblyInput): string {
  ...
  return [
    ...
    "- Exception: revenue, visitors/traffic, signups, and conversion-rate questions are time-sensitive — for these, confirm a time window (today, this week, this month, this quarter, this year, or all time) before answering instead of defaulting to all available data.",
